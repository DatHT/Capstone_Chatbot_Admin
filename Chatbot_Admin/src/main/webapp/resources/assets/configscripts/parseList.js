...
function appendcontents(item) {
    ...
    content = content + alertText + '</td></tr><tr><td><strong>Product Name</strong></td><td>';
    ...
    content = content + alertText + '</td></tr><tr><td><strong>Image</strong></td><td style="width: '
    ...
    appendto.innerHTML = content + '<button type="submit" class="btn btn-info m-b-10" id="btnAdd" name ="btnAction" value="AddNewPageList" onclick="addNew()" >AddNewPageList</button>';
//    sessionStorage.cart = '';
}