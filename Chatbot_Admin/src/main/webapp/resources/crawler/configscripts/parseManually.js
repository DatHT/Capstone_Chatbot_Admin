...
function addNew() {
    ...
    //appendcontents(sessionStorage.cart);
    document.myForm.submit();
}
...
function appendcontents(item) {
    //var item = items.split("'\'");
    var content='<h3>Recipe Information</h3><br/><table border="1" style="width: 485px" class="table"><thead></thead><tr><th style="width: 10%">Type</th><th style="width: 90%">Content</th></tr><tbody>'
            +'<tr><td><strong>Restaurant Name</strong></td><td>';
    //get recipeName
    ...
    var alertText = ""
    while (b) {
        //alertText += b.textContent + "<br/>" + '<input type="hidden" name="txtNAME" value="' + b.textContent + '"/>';
        alertText += '<input type="text" name="txtNAME" value="' + b.textContent + '" size="40"/>';
        b = a.iterateNext();
    }
    ...
    alertText = ""
    while (b) {
        //alertText += b.textContent + "<br/>" + '<input type="hidden" name="txtINTRODUCTION" value="' + b.textContent + '"/>';
        alertText += '<input type="text" name="txtADDRESS" value="' + b.textContent + '" size="40"/>';
        b = a.iterateNext();
    }   
    ...
    alertText = ""
    while (b) {
        alertText +='<input type="hidden" name="txtIMAGE" value="' + b.textContent + '"/>';
        b = a.iterateNext();
    }
    ...
    alertText = "";
    while (b) {
        alertText += '<input type="text" name="txtPRICE" value="' + b.textContent + '" size="40"/>';
        b = a.iterateNext();
    }
    ...
    alertText = "";
    while (b) {
        alertText += '<input type="text" name="txtTIME" value="' + b.textContent + '" size="40"/>';
        b = a.iterateNext();
    }
    ...
    alertText = "";
    while (b) {
        alertText += '<input type="text" name="txtRATE" value="' + b.textContent + '" size="40"/>';
        b = a.iterateNext();
    }
    ...
    alertText = "";
    while (b) {
        alertText += '<input type="text" name="txtUSER_RATE" value="' + b.textContent + '" size="40"/>';
        b = a.iterateNext();
    }
    ...
    alertText = ""
    while (b) {
        alertText += '<input type="text" name="txtGALLERY" value="' + b.textContent + '" size="40"/>';
        b = a.iterateNext();
    }
    content = content + alertText + '</td></tr><tr><td><strong>Map</strong></td><td style="width: '
            + '200px;  vertical-align: top">' + 'http:';
    //getIngredient
    ...
    alertText = "";
    while (b) {
        alertText += '<input type="text" name="txtMAP" value="' + b.textContent + '" size="40"/>';
        b = a.iterateNext();
    }
    content = content + alertText + '</td></tr></tbody></table>';
    appendto = document.getElementById('popup');
    appendto.innerHTML = content + '<input type="submit" class="btn btn-info m-b-10" value="INSERT" onclick="addNew()"/>';
//    sessionStorage.cart = '';
}
