					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading header-customize-color">
								<label class="header-customize-font"> Please Select An
									Element And Get XPath </label>
							</header>
							<div class="panel-body">
								<form name="myForm" id="myForm" action="ProcessServlet"
									...
									<div class="form-group">
										...
										<input type="button" class="btn btn-info m-b-10" value="BACK"
											onclick="back()" /> <input type="button"
											class="btn btn-info m-b-10" id="btnNext" value="NEXT"
											onclick="next()" />
										<!--disable-->
										<input type="button" class="btn btn-info m-b-10"
											id="btnPreview" value="PREVIEW" onclick="openpopup('popup')"
											disabled /> <input type="submit" class="btn btn-info m-b-10"
											id="btnAdd" name="btnAction" value="AddNewPageList"
											onclick="addNew()" disabled /> <input type="button"
											class="btn btn-info m-b-10" value="HOME"
									...
									<div class="col-sm-12">
										<iframe style="width: 100%"
											...
											width="700" height="500" id="myframe"
											src="<c:url value="/resources/tmp.html"/>"
