...
<script src="<c:url value = "/resource/configscripts/jquery-2.2.0.js"/>"
	type="text/javascript"></script>
<script src="<c:url value = "/resource/configscripts/loadConfigs.js"/>"
	type="text/javascript"></script>
<script src="<c:url value = "/resource/dist/sweetalert.min.js"/>"></script>
<link rel="stylesheet" type="text/css"
	href="<c:url value = "/resource/dist/sweetalert.css" />">

<!--right slidebar-->
<link href="<c:url value = "/resource/cssboostrap/slidebars.css" />"
	rel="stylesheet">

<!--switchery-->
<link href="<c:url value = "/resource/js/switchery/switchery.min.css"/>"
	rel="stylesheet" type="text/css" media="screen" />

<!--jquery-ui-->
<link
	href="<c:url value = "/resource/js/jquery-ui/jquery-ui-1.10.1.custom.min.css"/>"
	rel="stylesheet" />

<!--iCheck-->
<link href="<c:url value = "/resource/js/icheck/skins/all.css" />"
	rel="stylesheet">

<link href="<c:url value = "/resource/css/owl.carousel.css"/>"
	rel="stylesheet">


<!--common style-->
<link href="<c:url value="/resource/css/style.css" />" rel="stylesheet">
<link href="<c:url value="/resource/css/style-responsive.css" />"
	rel="stylesheet">

<link href="<c:url value="/resource/cssCode/customize.css" />"
	rel="stylesheet">
</head>
<body onload="return loadProcess('selectSite')" class="sticky-header">
	...
	<!--jquery-ui-->
	<script
		src="<c:url value ="/resource/js/jquery-ui/jquery-ui-1.10.1.custom.min.js" />"
		type="text/javascript"></script>
	...
	<script
		src="<c:url value= "/resource/js/switchery/switchery-init.js" />"></script>
