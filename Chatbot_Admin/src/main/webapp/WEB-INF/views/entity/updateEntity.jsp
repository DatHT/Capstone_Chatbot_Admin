							...
							<thead>
								<tr>
									<th data-column-id="number" data-type="numeric"
										data-identifier="true" data-sortable="false">No.</th>
									...
									<th data-column-id="urlRelate" data-sortable="false">Related
										Url</th>
								</tr>
							</thead>
							<tbody>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="add-form"
				action="addProduct?${_csrf.parameterName}=${_csrf.token}"
					...
					<div>
						<c:if test="${addResult != false}">
							...
							<div id="div-address">
								...
								<div class="fg-line">
									<input id="address" name="address" autocomplete="off"
										class="form-control" onblur="validAddress()"
							...
							<div id="div-rating">
								<label>Rating</label>
								<div class="fg-line">
									<input id="rating" name="rating" autocomplete="off"
										class="form-control" onblur="validRating()"
										onkeyup="validRating()">
								</div>
							...
							<div id="div-restaurant">
								...
								<div class="fg-line">
									<input id="restaurant" name="restaurant" autocomplete="off"
										class="form-control" onblur="validRestaurant()"
							...
							<div id="div-relatedUrl">
								...
								<div class="fg-line">
									<input id="relatedUrl" name="relatedUrl" autocomplete="off"
										class="form-control" onblur="validRelatedUrl()"
							...
							<div id="div-address">
								...
								<div class="fg-line">
									<input id="address" name="address" value="${address}"
										...
										onblur="validAddress()" onkeyup="validAddress()">
								</div>
								<small id="error-address" class="help-block"></small>
							</div>
							...
							<div id="div-rating">
								...
								<div class="fg-line">
									<input id="rating" name="rating" value="${rating}"
										autocomplete="off" class="form-control" onblur="validRating()"
										onkeyup="validRating()">
								</div>
								<small id="error-rating" class="help-block"></small>
							</div>
							...
							<div id="div-restaurant">
								...
								<div class="fg-line">
									<input id="restaurant" name="restaurant" value="${restaurant}"
										autocomplete="off" class="form-control"
										onblur="validRestaurant()" onkeyup="validRestaurant()">
								</div>
								<small id="error-restaurant" class="help-block"></small>
							</div>
							...
							<div id="div-relatedUrl">
								...
								<div class="fg-line">
									<input id="relatedUrl" name="relatedUrl" value="${relatedUrl}"
										autocomplete="off" class="form-control"
										onblur="validRelatedUrl()" onkeyup="validRelatedUrl()">
								</div>
								<small id="error-relatedUrl" class="help-block"></small>
							</div>
