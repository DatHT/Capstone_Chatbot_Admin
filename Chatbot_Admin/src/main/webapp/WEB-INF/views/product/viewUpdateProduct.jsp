...
<link href="${pageContext.request.contextPath}/resources/assets/css/updateProduct.css" rel="stylesheet">
        ...
        <div class="pmo-pic">
            <div class="p-relative">
                ...
                <a id="uploadThumb" href="#" class="pmop-edit" onclick="performClick('file')">
                    <i class="zmdi zmdi-camera"></i> <span class="hidden-xs">Update Picture</span>
                </a>
            </div>
        </div>
    </div>
