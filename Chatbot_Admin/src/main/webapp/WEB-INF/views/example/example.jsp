	...
	<div class="card" id="step2" style="padding-top: 0%">
		...
		<div class="card-body card-padding">
			<ul class="tab-nav tn-justified tn-icon" role="tablist">
				<li id="step-1" role="presentation" class="active"><a
					class="col-sx-3" style="color: red" href="#tab-1"
					aria-controls="tab-1" role="tab" data-toggle="tab"> Step 1 </a></li>
				<li id="step-2" role="presentation"><a class="col-xs-3"
					href="#tab-2" aria-controls="tab-2" role="tab" data-toggle="tab">
						Step 2 </a></li>
				<li id="step-3" role="presentation"><a class="col-xs-3"
					href="#tab-3" aria-controls="tab-3" role="tab" data-toggle="tab">
						Step 3 </a></li>
				<li id="step-4" role="presentation"><a class="col-xs-3"
					href="#tab-4" aria-controls="tab-4" role="tab" data-toggle="tab">
						Step 4 </a></li>
			</ul>
			...
			<div class="tab-content p-20">
				<div role="tabpanel" class="tab-pane animated fadeIn in active"
					id="tab-1">
					<div class="list-group-item-header palette-Purple text">Choose
						example in training bag</div>
					<div class="row">
						<div class="col-sm-7 m-b-15">
							<select class="chosen"
								data-placeholder="Some suggestion example..."
					...
					<div class="list-group-item-header palette-Purple text">Type
						your own example</div>
					<div class="row">
						<div class="col-sm-7 m-b-15">
				...
				<div role="tabpanel" class="tab-pane animated fadeIn" id="tab-2-x">
				...
				<div role="tabpanel" class="tab-pane animated fadeIn" id="tab-3-x">
					Serhoncus quis est sit amete in nisl molestie fringilla. Nunc vitae
					ante id magna feugiat condimentum. Maecenas sit amet urna massa.</div>

				<div role="tabpanel" class="tab-pane animated fadeIn" id="tab-4-x">
					Serhoncus quis est sit amete in nisl molestie fringilla. Nunc vitae
					ante id magna feugiat condimentum. Maecenas sit amet urna massa.</div>
			...
			<button onclick="displayStep2()"
				class="btn palette-Purple-300 bg btn-float waves-effect waves-circle waves-float">
					<i class="zmdi zmdi-arrow-right zmdi-hc-fw"></i>
			</button>
		</div>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-danger"
					onclick="deletePattern()">Delete</button>
			</div>
		</div>
	</div>
</div>
